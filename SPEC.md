...
主要配置：`AZURE_STATUS_RSS_URL`、`RSS_TIMEOUT_SECONDS`、`RSS_MAX_RETRIES`、`INGESTION_INTERVAL_SECONDS`、`DASHBOARD_POLL_SECONDS`、`DATABASE_PATH`、`LLM_PROVIDER`、`LLM_MODEL`、`LLM_API_KEY`、`LLM_TIMEOUT_SECONDS`、`LLM_MAX_RETRIES`、`LOG_LEVEL`。
